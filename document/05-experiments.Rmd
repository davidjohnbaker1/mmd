...
In order to model the data and investigate the  hypotheses, I fit a series of linear mixed effects models using the R programming langauge [@R-base] and the _lme4_ and _LmerTest_ [@batesFittingLinearMixedEffects2015;@lmerTest] packages to predict scores from the dictation exercise using both individual and musical variables.
...
```{r metable1, echo=FALSE, fig.cap="Mixed Effects Models 1",fig.align='center', out.width="100%"}
knitr::include_graphics("img/metable1.png")
```

```{r metable2, echo=FALSE, fig.cap="Mixed Effects Models 2",fig.align='center', out.width="100%"}
knitr::include_graphics("img/metable2.png")
```

```{r metable3, echo=FALSE, fig.cap="Mixed Effects Models 3",fig.align='center', out.width="100%"}
knitr::include_graphics("img/metable3.png")
```

```{r metable4, echo=FALSE, fig.cap="Mixed Effects Models 4",fig.align='center', out.width="100%"}
