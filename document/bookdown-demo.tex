...
the usefulness of this skill might even qualify as heretical. Though
researchers like Klonoski has raised important questions like ``What
specific deficiency is revelaned with an incorrect reponse in melodic
dictaiton settings?'' \citep{klonoskiImprovingDictationAuralSkills2006}
It is this ability to think \emph{in} music that h

\begin{itemize}
\item
  \citep{schumannMusikalischeHausUnd1967} - dumb schumann quote
\item
  1934 quote about hear with eye, see with ear \citep{smith1934solfege}
\item
  McGaughy 1961 " qualified musicians must develop reading, singing, and
  {[}italics added{]} notational skills in order to achieve acuity of
  aural perception and to make effective use of that acuity" (p.~i)."
\item
