...
and occur as a looping process depicted in Figure 1.
...
This process might generalize to many tonal melodies, but presumably different strategies in recognition would be involved in dictating the two melodies of equal length shown in Figure 2 and 3.

```{r, echo=FALSE, fig.cap="Melodies of Equal Length",fig.align='center', dpi=50}
knitr::include_graphics("img/musicalexamples/MMD_Figure2-1.png.png")
knitr::include_graphics("img/musicalexamples/MMD_Figure3-1.png.png")
...
The taxonomy that I propose appears in Figure 4 and bifucates the possible factors thought to affect an individual's ability to take melodic dictation into two categories: **individual** parameters and **musical** parameters.
...
```{r, echo=FALSE, fig.cap="Taxonomy of Factors Contributing to Aural Skills",fig.align='center', dpi=30}
