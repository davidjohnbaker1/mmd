...
This encoding decision is reflected in the Key Distribution panel of @ref(fig:melosol\_descriptive\_panel).
...
(\#fig:melosol\_descriptive\_panel)
\textbackslash{}end\{figure\}

Figure @ref(fig:melosol\_descriptive\_panel) shows basic descriptive statistics of the \emph{MeloSol} corpus.
...
In order to compare the \_Essen\_collection with the \emph{MeloSol} corpus, I first plot general level descriptive features of all corpora in @ref(fig:comp\_desc).
...
This operant definition requires expert selection of what a chunk is and also does not take into account any of the Experimental factors put forward in the taxnomy presented in this dissertation's {[}Theoretical Backgorund and Rationale{]}.
