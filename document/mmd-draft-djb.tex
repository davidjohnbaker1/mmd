...
Additionally, \citet{colleyWorkingMemoryAuditory2018} found working memory capacity, as measured by a backwards digit span and operation span, to be successful predictors in a tapping task requiring sensory motor prediction abilities.
...
{\centering \includegraphics[width=0.8\linewidth]{img/musicalpuzzle} 

}

\caption{A Musical Puzzle}\label{fig:musicalpuzzle}
\end{figure}
