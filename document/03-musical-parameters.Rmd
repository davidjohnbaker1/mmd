...
Following up on this analysis, I then trained an IDyOM model on the same corpus of melodies and thus was able to calculate the average information content the opening quint grams melodies in this corpus.
...
I chose to additionally split the corpus into quintiles to further highlight the progressive changes in information content when these incipits are sorted based on their cumulative informaiton content.
...
collapse across for distirbution 

From these computations, we can see that almost tautologically, that quint-grams with higher cumulative information content appear with lower frequency and m-grams with lower cumulative information content occur more frequently.
