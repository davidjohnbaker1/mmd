...
```{r musicalpuzzleA, echo=FALSE, fig.cap="A Musical Puzzle",fig.align='center', out.width="100%"}
knitr::include_graphics("img/musicalpuzzle/MP2/MP_X-1.png")
```

```{r musicalpuzzleB, echo=FALSE, fig.cap="B Musical Puzzle",fig.align='center', out.width="100%"}
knitr::include_graphics("img/musicalpuzzle/MP2/MP_Y-1.png")
```
...
In this survey, participants were asked the questions presented in Table \@ref(tab:surveyQuestions1) and Table \@ref(tab:surveyQuestions2) using a sample of 20 melodies found in the a commonly used sight-singing text book [@berkowitzNewApproachSight2011].
...
`Demographic Questions` <- c("What is your age, in years?", "What is your educational status?", "How many years have you been teaching Aural Skills at the University level?", "Which type of syllable system do you prefer to use?", "On which instrument have you gained the most amount of professional training?", "What is the title of the last degree you received?", "At what institution are you currently teaching?")
...
The survey can be found at https://musiccog.lsu.edu/dictation_survey/aural_survey.html. 
...
```{r surveyageeducation, echo=FALSE, fig.cap="Demographic Breakdown of Survey Sample",fig.align='center', out.width="80%"}
knitr::include_graphics("img/ageedsurveydistribution.png")
```


```{r berk3, echo=FALSE,fig.cap="Melody 3   | Rank 1", fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz3.png")
```

```{r berk9, echo=FALSE,fig.cap="Melody  9  | Rank 2",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz9.png")
```

```{r berk26, echo=FALSE,fig.cap="Melody 26 | Rank 3",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz26.png")
```

```{r berk59, echo=FALSE,fig.cap="Melody 59 | Rank 4",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz59.png")
```

```{r berk70, echo=FALSE, fig.cap="Melody 70 | Rank 5", fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz70.png")
```

```{r berk74, echo=FALSE, fig.cap="Melody 74 | Rank 6",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz74.png")
```

```{r berk75, echo=FALSE, fig.cap="Melody 75 | Rank 7", fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz75.png")
```

```{r berk88, echo=FALSE,fig.cap="Melody 88 | Rank 8",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz88.png")
```

```{r berk156, echo=FALSE,fig.cap="Melody 156 | Rank 9",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz156.png")
```

```{r berk282, echo=FALSE,fig.cap="Melody 282 | Rank 10",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz282.png")
```

```{r berk294, echo=FALSE, fig.cap="Melody 294 | Rank 11",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz294.png")
```

```{r berk312, echo=FALSE, fig.align='center', fig.cap="Melody 312 | Rank 12", out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz312.png")
```

```{r berk334t, echo=FALSE, fig.cap="Melody 334 | Rank 13", fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz334t.png")
```

```{r berk379, echo=FALSE,fig.align='center', fig.cap="Melody 379 | Rank 14", out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz379.png")
```

```{r berk382, echo=FALSE, fig.cap="Melody 382 | Rank 15", fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz382t.png")
```

```{r berk417tx, echo=FALSE,fig.cap="Melody 417 | Rank 16",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz417tx.png")
```

```{r berk607tx, echo=FALSE,fig.cap="Melody 607 | Rank 17",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz607tx.png")
```

```{r berk622, echo=FALSE,fig.cap="Melody 622 | Rank 18",fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz622.png")
```

```{r berk627, echo=FALSE,fig.cap="Melody 627 | Rank 19", fig.align='center', out.width="100%"}
knitr::include_graphics("img/survey_melodies/Berkowitz627.png")
```

```{r berk629, echo=FALSE, fig.cap="Melody 629 | Rank 20",fig.align='center', out.width="100%"}
...
Using an intraclass coefficient calculation of agreement using a two-way model, with melodies and raters treated as random effects, the sample reflects an interclass coeffiecent of .65, which according to @kooGuidelineSelectingReporting2016 indicates a moderate degree of agreement among raters.
...
Ortman referred to these as determinants, while others such as Müllensiefen refer to them as features [@mullensiefenFantasticFeatureANalysis2009].
...
In order to investigate the frequency facilitation hypothesis, I conducted a corpus study using N = 622 melodies from the above using the Fifth Edition of the Berkowitz "A New Approach to Sight Singing" [@berkowitzNewApproachSight2011].
...
```{r bitriquint, echo=FALSE, fig.cap="Distribution of n-grams",fig.align='center', out.width="100%"}
knitr::include_graphics("img/trigrams.png")
```

```{r bitriquint2, echo=FALSE, fig.cap="Distribution of Bi- Tri- and Quint- grams",fig.align='center', out.width="100%"}
...
As evident from Figure \@ref(fig:bitriquint), we see that with the addition of more tokens added to the n-grams, this results in a visual representation of why and how statistical predictions become more unreliable with higher order predictions [@conklinMultipleViewpointSystems1995]. 
...
```{r quintdist, echo=FALSE, fig.cap="Distribution of Opening Quint grams",fig.align='center', out.width="100%"}
...
```{r tridensity, echo=FALSE, fig.cap="Average Information Content of Opening Quint-grams of Melodies",fig.align='center', out.width="100%"}
...
```{r modelcomparison, echo=FALSE, fig.cap="Model Comparison",fig.align='center', out.width="100%"}
...
As discussed in [Working Memory and Melodic Dictation], using measures of information content could provide an ecologically acceptable solution to the problems of chunking within music.
...
Future work should investigate this experimentally and look to model it using similar methodologies that have been employed in music psychology testing paradigms [@harrisonApplyingModernPsychometric2017a; @wolfGradesReflectDevelopment2014].
...
### Limitations of Frequency Facilitation Hypothesis 
...
In the case of auditory learning, there is research to assert this claim from both the field of implicit learning and statistical learning as discussed by @perruchetImplicitLearningStatistical2006.
For example, extensive evidence as reviewed by @cleeremansComputationalModelsImplicit2008 provides many examples of this, and especially worth highlighting is that people have been show to learn variable order n-gram patterns [@remillardImplicitLearningFirst2001].

This assertion is importantly contrasted by work such as @jamiesonApplyingExemplarModel2009 who claim that explaining these phenomena as resulting in statistical learning is not necessary.
...
This assertion is important to highlight because as noted by @perruchetImplicitLearningStatistical2006, statistical learning depends on the tacit assumption that people might be performing some sort of real-time calculations on incoming stimuli in real time.
