...
```{r musicalpuzzleA, echo=FALSE, fig.cap="A Musical Puzzle",fig.align='center', out.width="80%"}
knitr::include_graphics("img/musicalpuzzle/MP2/MP_X-1.png")
```

```{r musicalpuzzleB, echo=FALSE, fig.cap="B Musical Puzzle",fig.align='center', out.width="80%"}
