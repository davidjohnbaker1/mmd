...
But does the literature support that?\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.07\columnwidth}\raggedright
III. Mem 4 melodies
...
\begin{minipage}[t]{0.07\columnwidth}\raggedright
IV. Experiment
V. Results and MODEL discussion\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.07\columnwidth}\raggedright
...
will investigate question of PF with corpus evdience in next chapter\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
accd to Pereceptual fluency hyptthessis which states\ldots{}\ldots{}
...
\hypertarget{distributional-frequency-hypothesis}{%
\section{Distributional Frequency Hypothesis}\label{distributional-frequency-hypothesis}}
...
\hypertarget{perceptual-theories-of-implicit-learning}{%
\subsection{Perceptual Theories of Implicit Learning}\label{perceptual-theories-of-implicit-learning}}
...
\hypertarget{logical-argument}{%
\subsection{Logical Argument}\label{logical-argument}}
