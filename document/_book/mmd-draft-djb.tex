...
\caption{Cadential Excerpt from Schubert's Octet in F Major}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Cumulative Information in Schubert Octet Excerpt}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Formal Model}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Model Example}\label{fig:unnamed-chunk-4}
\end{figure}
