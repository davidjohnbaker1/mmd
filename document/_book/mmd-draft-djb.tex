...
\usepackage[left=1.5in, right=1.5in, top=2.5in, bottom=2.5in]{geometry}
\usepackage{hyperref}
...
As noted in Figure \ref{fig:memodeltable2}, both a significant main effect of Tonalness and Note Density was found, as well as a small interaction between the two variables suggesting evidence supporting rejecting \(H2\)'s null hypothesis.
