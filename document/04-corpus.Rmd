...
This encoding decision is reflected in the Key Distribution panel of \@ref(fig:melosol_descriptive_panel).
...
In order to compare the _Essen_collection with the _MeloSol_ corpus, I first plot general level descriptive features of all corpora in \@ref(fig:comp_desc).
