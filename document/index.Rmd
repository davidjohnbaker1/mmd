...
This chasm in the literature also raises a disconserning question amongst pedagogy: 
...
I do this by syntehsizing literature from both music and science in order to demonstrate how tools from both cognitive psychology as well as computational musicology can be used to help inform pedagogical practices.
...
The chapter introduces both a theoretical background and rationale for using methods from both computational musicology and cognitive psychology in order to answer questions bout how individuals learn melodies.
...
I argue that since the first two steps of Karpinki's model of melodic dictaiton do not require any musical training, teasing apart the individual factors that contribute to melodic dictation can be done using a memory for melodies paradigm and structural equation modeling. 
I interpret the results of the data and analysis to highligh the importance of working memory processess in melodic dictaiton.
...
The third chapter of the dissertation discusses how aural skills pedagogy could benefit from using methodlogies computational musicology in order to inform their practice.
The chapter begins by establishing the degree to which aural skills pedagoges agree on the difficulty of melodies for melodic dictation using a small survey.
I then show how different sets of tools from computational musicology can approximate the intutions of aural skills pedagogues from the survey.
The chapter concludes by putting forward a novel theory of musical memory-- The Frequency Facilitation Hypothesis-- derrived from computational methodologies.
...
Stimuli for the experiments are selected based on the abstracted, computational features of the melodies discussed in earlier chaptersand are manipulated as independent variables based on the previous theoretical literature. 
