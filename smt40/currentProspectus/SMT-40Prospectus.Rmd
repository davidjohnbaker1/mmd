...
To give an example, both melodies from Figure 2 and 3 are 20 notes in length, yet the strategies and thus perceived difficulty of dictating each melody would be presumably different for individuals with different musical training backgrounds.
Not only will an individual's prior experience affect this process, but presumably the melodic material will as well.

In this dissertation, I continue the line of research began with Gary Karpinski's four step model of melodic dictation by continuing beyond this four step model.
...
In order to do this, I synthesize and utilize work from music theory, music education, and music cognition to answer questions related to this.
Since the goal of this research is to improve the music theorists ability to be effective pedagogues, I frame my research question in relation answering questions as they relate to undergraduate students.^[Although pedagogically focused, the research here also has more domain general applications and relevance.]
...
2. How can abstracted melodic features help determine the difficulty of dictation melody in line with expert intuition?
...
Contrary to a descriptive model like Karpinkski's Four Step Model, an explanatory model not only posits _what_ will happen, but hypothesizes the inner workings of the process and asserts both _how_ and _why_.
...
Given its importance to the responsibilities of most music theorists, a working theory of how melodic dictation would only further our pedagogical understandings. 
...
As mentioned above, work from this dissertation suggests that working memory does in fact play a large role in question of melodic perception, thus corroborating earlier claims by @berzWorkingMemoryMusic1995.
This also dissertation puts forward a new corpus of over 600+ melodies that can be used by the computational musicology community.
...
A review of melodic dictation literature as it relates to Karpinksi as well as the computational model as it pertains to music theory pedagogy will also be published in a journal where the readership overlaps between music theory, music cognition, and music education. 
...
```{r, echo=FALSE, fig.cap="Figure 2: Melodies of Equal Length: Tonal",fig.align='center', out.width="100%"}
knitr::include_graphics("MMD_Figure2-1.png")
```

```{r, echo=FALSE, fig.cap="Figure 3: Melodies of Equal Length: Atonal",fig.align='center', out.width="100%"}
knitr::include_graphics("MMD_Figure3-1.png")
```

```{r, echo=FALSE, fig.cap="Taxonomy of Factors Relating to Melodic Dictation",fig.align='center', out.width="100%"}
